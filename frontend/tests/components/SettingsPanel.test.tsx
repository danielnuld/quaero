...
function mount(over: {
  ...
  onSetSkin?: (s: "indigo" | "navicat") => void;
...
describe("SettingsPanel", () => {
  ...
  it("reports an accent-skin change through the handler", () => {
    ...
    const navicat = [...host!.querySelectorAll(".chip")].find((c) => c.textContent === "Navicat (azul)")!;
    (navicat as HTMLButtonElement).click();
    expect(onSetSkin).toHaveBeenCalledWith("navicat");
  });
