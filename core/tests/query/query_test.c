...
int main(void)
{
    ...
    g_result = &rs;
    {
        ...
        dbc_status st = dbcore_query_run(&ref, "SELECT ...", 0, &res, err, sizeof err);
    ...
    {
        dbcore_result *res = NULL;
        dbc_status st = dbcore_query_run(&ref, "SELECT ...", 2, &res, err, sizeof err);
    ...
    /* --- an empty result set (columns, zero rows) --- */
    {
        ...
        g_result = &empty;
        dbcore_result *res = NULL;
        dbc_status st = dbcore_query_run(&ref, "SELECT ... WHERE 0", 0, &res, err, sizeof err);
    ...
    /* --- a statement with no result set (INSERT/UPDATE) --- */
    {
        ...
        g_result = &noset;
        dbcore_result *res = NULL;
        dbc_status st = dbcore_query_run(&ref, "UPDATE ...", 0, &res, err, sizeof err);
    ...
    /* --- query execution failure propagates the driver's last_error --- */
    {
        ...
        g_result = NULL;
        dbcore_result *res = NULL;
        dbc_status st = dbcore_query_run(&ref, "SELCT", 0, &res, err, sizeof err);
    ...
    {
        dbcore_result *res = NULL;
        EXPECT(dbcore_query_run(NULL, "x", 0, &res, err, sizeof err) == DBC_ERR_PARAM, "NULL conn");
        EXPECT(dbcore_query_run(&ref, NULL, 0, &res, err, sizeof err) == DBC_ERR_PARAM, "NULL sql");
        EXPECT(dbcore_query_run(&ref, "x", 0, NULL, err, sizeof err) == DBC_ERR_PARAM, "NULL out");
    }
    ...
    /* --- a NULL errbuf / zero capacity must not crash --- */
    {
        ...
        g_result = NULL;
        dbcore_result *res = NULL;
        EXPECT(dbcore_query_run(&ref, "x", 0, &res, NULL, 0) == DBC_ERR_QUERY,
